...
\begin{feynman}
  \vertex [blobv] (H) at (0,0) {};
  \vertex [dot] (a) at (0.9,0.62) {}; \vertex [dot] (b) at (0.9,-0.62) {}; \vertex [dot] (e) at (2.15,0.95) {};
  \vertex (oi) at (3.2,1.30); \vertex (ok) at (3.2,-1.05); \vertex (og) at (3.2,0.40);
  \diagram*{ (H)--[charged scalar](a), (H)--[charged scalar](b), (a)--[gluon, half left, looseness=1.3](b),
    (a)--[charged scalar](e), (e)--[charged scalar](oi), (e)--[gluon](og), (b)--[charged scalar](ok), };
\end{feynman}\end{tikzpicture}
&
\begin{tikzpicture}[baseline=(current bounding box.center),scale=0.82,every node/.style={transform shape}]
\begin{feynman}
...
production vertex. The gauge-invariant set comprises the box (a), the factorizable
hard-vertex correction (b) and the scalar seagull (c) --- the four-point
$\tilde q\tilde q gg$ vertex at the lower vertex; crossing-symmetric partners are
understood. The single colour decomposition $2\,\Top{i}^a\Top{i}^b
...
all massive bubbles are known in closed form to \emph{all orders} in $\eps$, and
...
pieces are singular. The scalar radiator carries the \emph{soft} singularity,
which is universal and mass-independent. The magnetic remainder is singular only in
the genuine \emph{collinear} limit --- and, as Sec.~\ref{sec:nosector} shows, that
...
remainder is therefore \emph{finite} for a massive quark.

The consequence, already anticipated by Czakon in the context of massive NNLO
subtraction, is that \emph{the scalar radiator is the complete ingredient}. A
...
same fact makes the radiator the \emph{complete} heavy-quark ingredient: the
