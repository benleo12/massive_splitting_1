...
\centering
\begin{tabular}{cccc}
\begin{tikzpicture}[baseline=(current bounding box.center),scale=0.72,every node/.style={transform shape}]
\begin{feynman}
  \vertex [blobv] (H) at (0,0) {};
  \vertex [dot] (a) at (1.05,0.72) {};  \vertex [dot] (c) at (2.30,0.72) {};
  \vertex [dot] (b) at (1.55,-0.80) {};
  \vertex (oi) at (3.3,1.10);  \vertex (ok) at (3.3,-1.15);  \vertex (og) at (1.55,1.55);
  \diagram*{ (H) -- [charged scalar] (a), (a) -- [charged scalar] (c), (c) -- [charged scalar] (oi),
    (c) -- [gluon] (b), (H) -- [charged scalar] (b), (b) -- [charged scalar] (ok), (a) -- [gluon] (og), };
\end{feynman}\end{tikzpicture}
&
\begin{tikzpicture}[baseline=(current bounding box.center),scale=0.72,every node/.style={transform shape}]
\begin{feynman}
  \vertex [blobv] (H) at (0,0) {};
  \vertex [dot] (a) at (1.0,0.75) {};  \vertex [dot] (b) at (1.0,-0.75) {};
  \vertex [dot] (c) at (2.2,-0.75) {};
  \vertex (oi) at (3.3,1.15);  \vertex (ok) at (3.3,-1.15);  \vertex (og) at (3.3,-0.30);
  \diagram*{ (H) -- [charged scalar] (a), (H) -- [charged scalar] (b), (a) -- [gluon] (c),
    (a) -- [charged scalar, out=30, in=150] (oi), (b) -- [charged scalar] (c),
    (c) -- [charged scalar] (ok), (c) -- [gluon] (og), };
\end{feynman}\end{tikzpicture}
&
\begin{tikzpicture}[baseline=(current bounding box.center),scale=0.72,every node/.style={transform shape}]
\begin{feynman}
  \vertex [blobv] (H) at (0,0) {};
  \vertex [dot] (a) at (0.85,0.62) {};  \vertex [dot] (b) at (0.85,-0.62) {};
  \vertex [dot] (e) at (2.15,0.90) {};
  \vertex (oi) at (3.2,1.25);  \vertex (ok) at (3.2,-1.05);  \vertex (og) at (3.2,0.35);
  \diagram*{ (H) -- [charged scalar] (a), (H) -- [charged scalar] (b), (a) -- [gluon] (b),
    (a) -- [charged scalar] (e), (e) -- [charged scalar] (oi), (e) -- [gluon] (og),
    (b) -- [charged scalar] (ok), };
\end{feynman}\end{tikzpicture}
&
\begin{tikzpicture}[baseline=(current bounding box.center),scale=0.72,every node/.style={transform shape}]
\begin{feynman}
  \vertex [blobv] (H) at (0,0) {};
  \vertex [dot] (sg) at (1.6,0.80) {};  \vertex [dot] (b) at (1.15,-0.80) {};
  \vertex (oi) at (3.1,1.15);  \vertex (ok) at (3.1,-1.15);  \vertex (og) at (3.1,0.55);
  \diagram*{ (H) -- [charged scalar] (sg), (sg) -- [charged scalar] (oi), (sg) -- [gluon] (og),
    (sg) -- [gluon] (b), (H) -- [charged scalar] (b), (b) -- [charged scalar] (ok), };
\end{feynman}\end{tikzpicture}
\\[1mm]
\footnotesize (a) box & \footnotesize (b) crossed box & \footnotesize (c) factorizable & \footnotesize (d) seagull
\end{tabular}
\caption{Box-type diagrams contributing to the scalar--scalar interference at one
loop --- the massive analogue of Fig.~14 of Ref.~\cite{Campbell:2025}. Dashed
arrowed lines are charged scalars, coiled lines gluons, the grey blob the hard
production vertex. A gauge-invariant set is formed by the box (a), crossed box
(b), the factorizable hard-vertex correction (c), and the scalar seagull (d).
The single colour decomposition $2\,\Top{i}^a\Top{i}^b=if^{abc}\Top{i}^c
+\{\Top{}^a,\Top{}^b\}_i$ splits their sum into the abelian
($\{\Top{}^a,\Top{}^b\}$, $13$ masters) and non-abelian ($f^{abc}$, $14$ masters)
radiators. The topology of Ref.~\cite{Campbell:2025} with the gluon emitted off a
colour-charged spectator $l\neq i,k$ is absent here, as the source produces only
the $i,k$ dipole.}
\label{fig:boxes}
\end{figure}
...
Fig.~\ref{fig:boxes}. A gauge-invariant set is formed by the box (a), crossed box
(b), the factorizable hard-vertex correction (c) and the scalar seagull (d).
...
computed here there is no spectator, so that topology does not arise. The
hard-vertex correction (c) evaluates to
\begin{equation}
  I_{h,f}(Q^2,t)=-\frac{g_s^2}{16\pi^2}\,\Top{i}^b\Top{k}^b\,
  \Big(\big(2Q^2-t\big)\,\Ihat_3^{2m}(Q^2,t)+\Ihat_2(Q^2)-\Ihat_2(t)\Big)\;,
  \label{eq:hardvertex}
\end{equation}
whose $t\to0$ limit is $2Q^2\Ihat_3^{1m}(Q^2)+\Ihat_2(Q^2)$. Using
...
dipole radiator of Sec.~\ref{sec:massless} plus a  {magnetic remainder}. In
...
evaluated with identical loop content on the two sides: gluon, ghost and closed
 {quark} loops on both, no gluino and no closed  {squark} loops. We have
...
We emphasise that Eq.~\eqref{eq:magnetic-remainder} is  {not} evaluated in
