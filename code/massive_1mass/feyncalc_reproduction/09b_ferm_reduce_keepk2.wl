(* 09ferm (Deliverable B, step 2): resolve the closed-quark-loop FLAVOUR SUM, then
   ...
   Output: ampRaw_quark_1mass_full.txt + master basis. *)
...
DumpSave["/tmp/ferm_reduced_full.mx", tot];
Export[FileNameJoin[{base,"for_stefan_1mass","ampRaw_quark_1mass_full.txt"}],
   ToString[FCE[tot], InputForm], "Text"];
Print["saved ampRaw_quark_1mass_full.txt"];
